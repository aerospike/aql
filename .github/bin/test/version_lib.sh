...
# The lines `aql --version` must print for that string. print_version() splits
# on "-": the core goes on the Version line and the last field, if any, on a
# Build line.
#
#   9.2.10-rc1        Version 9.2.10 / Build rc1
#   9.2.10-abc123def  Version 9.2.10 / Build abc123def
#   9.2.10            Version 9.2.10
